...
.after:
	...
	; read drive parameters (sectors per track andd head count)
	; instad of using data on the formatted disk
	push es
	mov ah, 08h
	int 13h
	jc floppy_error
	...
	inc ax									; division remainder !=0, add 1
											; thus, a sector is only partially filled with entries
...
.read_finish:
	...
	jmp wait_key_and_reboot 				; is not supposedd to happen
