...
global __U4D
__U4D:
    shl edx, 16         ; dx to upper half of eddx
...
_x86_Video_WriteCharTeletype:
    ...
    ; a single byte can't be pushed to the stack, they are converted to words
    mov ah, 0Eh 
    mov al, [bp + 4]
    mov bh, [bp + 6]
...
_x86_Disk_Read:
    ...
    ; set return value
    mov ax, 1
    sbb ax, 0           ; 1 if success, else 0

    ; restore regs
    pop es
    pop bx

    ; restoring the old call frame
    mov sp, bp
    pop bp
    ret
